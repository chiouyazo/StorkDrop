...
The included `manifest.json` shows every supported manifest field for a product package, including shortcuts, cleanup rules, plugin declarations, and requirements.
