...
public sealed class ManifestValidatorTests
{
    ...
    [Fact]
    public void Validate_ValidEnvironmentVariables_ShouldBeValid()
    {
        ProductManifest manifest = CreateValidManifest() with
        {
            EnvironmentVariables =
            [
                new EnvironmentVariableInfo("ACME_HOME", "{InstallPath}", "set"),
    ...
    [Fact]
    public void Validate_EnvironmentVariable_EmptyName_ShouldReturnError()
    {
        ProductManifest manifest = CreateValidManifest() with
        {
            EnvironmentVariables = [new EnvironmentVariableInfo("", "{InstallPath}", "set")],
        };
    ...
    [Fact]
    public void Validate_EnvironmentVariable_InvalidAction_ShouldReturnError()
    {
        ProductManifest manifest = CreateValidManifest() with
        {
            EnvironmentVariables = [new EnvironmentVariableInfo("FOO", "bar", "invalid")],
        };
    ...
    [Fact]
    public void Validate_EnvironmentVariable_InvalidTarget_ShouldReturnError()
    {
        ProductManifest manifest = CreateValidManifest() with
        {
            EnvironmentVariables =
            [
                new EnvironmentVariableInfo("FOO", "bar", "set", Target: "invalid"),
            ],
        };
